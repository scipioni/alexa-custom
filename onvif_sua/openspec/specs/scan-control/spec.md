# scan-control Specification

## Purpose

Provide operator control over manual subnet scans: exposing whether a scan is currently running and allowing an in-progress scan to be stopped cooperatively from both the API and the dashboard.
