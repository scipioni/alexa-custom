# web-dashboard-polling Specification

## Purpose

Define the client-side polling cadence and pause behavior of the web dashboard, keeping the dashboard a lightweight monitoring view whose polling never affects the authoritative MQTT alarm path.
