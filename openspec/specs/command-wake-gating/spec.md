# Capability: Command Wake Gating

## Purpose
Control whether a trigger fires freely (direct match) or only after a wake word is detected, using a per-trigger boolean flag.
