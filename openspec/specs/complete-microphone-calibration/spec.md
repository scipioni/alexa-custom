# Spec: Complete Microphone Calibration

## Purpose

Provides an automatic, multi-stage voice calibration routine that tunes both the microphone hardware input gain level and the GStreamer WebRTC pre-processing filter parameters (noise suppression and automatic gain control) to optimize speech-to-text accuracy.
