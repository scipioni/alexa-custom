# Capability: Configuration Layout

## Purpose
Standardise the configuration files under a unified layout and ensure credentials are never checked into version control.
