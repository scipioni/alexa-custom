# Capability: Config Error Feedback

## Purpose
Provide audible feedback to the operator when a hot-reload of `config.yaml` fails, alerting them immediately on a headless device where there may be no visible terminal.
