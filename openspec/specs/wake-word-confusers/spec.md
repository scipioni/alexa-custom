# Capability: Wake Word Confusers

## Purpose
Reduce false wake-word triggers by adding confuser phrases to the stage-1 grammar. Confuser phrases are recognised by Vosk but silently rejected, preventing TV audio, partial utterances, or phonetically similar words from accidentally entering command mode.
